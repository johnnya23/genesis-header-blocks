...
if (! class_exists('UAGB_Helper')) {
    ...
    class UAGB_Helper
    {
        ...
        {
            /* john antonacci start change here */
            $this_post = array();
            $these_posts = array();
            ...
            if (class_exists('WooCommerce')) {
                ...
                if (is_object($this_post)) {
                    $these_posts[] = $this_post;
                }
            }
            if ((is_single() || is_page() || is_404()) && !count($these_posts)) {
                global $post;
                $this_post = $post;
            ...
            $these_posts = apply_filters('jma_ghb_uagb_post_for_stylesheet', $these_posts);
            ...
            /* john antonacci end change here */
        }
